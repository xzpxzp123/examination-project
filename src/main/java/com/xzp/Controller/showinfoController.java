...
public class showinfoController {
    ...
    public ResopnseResult showTeacherInfo (@RequestHeader("token") String token) throws Exception {
...
//        }
    ...
    public ResopnseResult showStudentInfo(@RequestHeader("token") String token) throws Exception {
...
@RequestMapping("/Teacher/contro/show/showtestPaperInfo")
    public ResopnseResult showtestPaperInfo(@RequestParam String course){
...
//        }
    ...
    public ResopnseResult gradePaper(@RequestBody ExamSubmmitDTO examSubmmitDTO,@RequestHeader("token")String token) throws Exception {
